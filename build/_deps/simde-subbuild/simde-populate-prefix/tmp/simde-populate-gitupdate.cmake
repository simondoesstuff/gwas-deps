...
execute_process(
  COMMAND "/Users/simon/.nix-profile/bin/git" --git-dir=.git show-ref "master"
  WORKING_DIRECTORY "/Users/simon/Code/work/gwas-deps/build/_deps/simde-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/simon/Code/work/gwas-deps/build/_deps/simde-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/simon/Code/work/gwas-deps/build/_deps/simde-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
